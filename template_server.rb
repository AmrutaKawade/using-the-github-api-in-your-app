...
class GHAapp < Sinatra::Application
  ...
  helpers do
    ...
    def authenticate_app
      ...
      # Sender url is in this format https://chghae2.githubtest.com/api/v3/users/amk. removing end part
      url = @payload["sender"]["url"]
      @baseUrl, tail = url.split('/users')
      logger.debug @baseUrl
      # Create the Octokit client, using the JWT as the auth token.
      @app_client ||= Octokit::Client.new(bearer_token: jwt, api_endpoint: @baseUrl)
      logger.debug @app_client
    end
    ...
    def authenticate_installation(payload)
      ...
      @installation_client = Octokit::Client.new(bearer_token: @installation_token, api_endpoint: @baseUrl)
    end
